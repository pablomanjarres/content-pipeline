...
function MediaCard({ file, index, selected, onToggle }: {
  ...
  const copyPath = async (e: MouseEvent) => {
    e.stopPropagation()
    try {
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`absolute top-2 right-2 w-7 h-7 rounded-full flex items-center justify-center backdrop-blur transition-all cursor-pointer ${
            copied
