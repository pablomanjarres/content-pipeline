    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            { label: 'building', pct: 70, color: '#f97316', examples: ['the product demos', 'bugs', 'progress', 'features'] },
...
const CONTENT_TYPES = [
  { label: 'Build', color: '#f97316', items: ['the product demos', 'Bugs fixed', 'Progress updates'] },
