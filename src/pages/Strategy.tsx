    ...
    <div className="space-y-8">
      ...
      <motion.section {...fade(0.15)}>
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: 'building', pct: 70, color: '#f97316', examples: ['Nella demos', 'bugs', 'progress', 'features', 'launches'] },
...
const PIPELINE_STEPS = [
  ...
  { icon: '📂', label: 'Upload', desc: 'Upload to dashboard → goes to nella-videos/{week}/uploads-{date}/', time: 'instant', color: '#8b5cf6' },
...
const CONTENT_TYPES = [
  { label: 'Build', color: '#f97316', items: ['Nella demos', 'Bugs fixed', 'Progress updates', 'Feature launches'] },
